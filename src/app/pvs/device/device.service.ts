...
export class DeviceService {
  ...
  hubDeviceGroups: DeviceGroup[] = [
    ...
    name: 'CGS연동 허브 - ZW',
    deviceList: [
      {value: 'cgs_zw_01', modelValue: 'IHU50', typeValue: 'HUB', viewValue: '독립형허브(고급)', pvsValue: ''},
      {value: 'cgs_zw_02', modelValue: 'GIHG20', typeValue: 'SHUB', viewValue: '보급형허브', pvsValue: ''},
      {value: 'cgs_zw_03', modelValue: '000000010001', typeValue: 'DHUB', viewValue: '동글형허브1(구형)', pvsValue: ''},
      {value: 'cgs_zw_04', modelValue: '018B00020001', typeValue: 'DHUB', viewValue: '동글형허브2(신형)', pvsValue: ''},
      {value: 'cgs_zw_05', modelValue: '018B00020001', typeValue: 'LTEDHUB', viewValue: 'LTE동글형허브', pvsValue: ''},
      {value: 'cgs_zw_06', modelValue: 'LAP255U', typeValue: 'WHUB', viewValue: 'WOOFER', pvsValue: ''},
      {value: 'cgs_zw_07', modelValue: 'LGU-TVG-01', typeValue: 'TVG', viewValue: 'TVG', pvsValue: ''}
    ]
  },
  {
    name: 'OAS연동 허브 - WIFI',
    deviceList: [
      {value: 'oas_wifi_01', modelValue: 'CDP-1021DW', typeValue: 'WPADHUB', viewValue: '홈넷 월패드허브(코맥스)', pvsValue: ''},
      {value: 'oas_wifi_02', modelValue: 'DWHN_2000', typeValue: 'WPADHUB', viewValue: '홈넷 월패드허브(현대통신)', pvsValue: ''},
      {
        value: 'oas_wifi_03',
        modelValue: 'CSH-3130',
        typeValue: 'WPADHUB',
  ...
  },
  {
    name: 'OGS연동 허브 - WIFI',
    deviceList: [
      {value: 'ogs_wifi_01', modelValue: 'IRHG-01', typeValue: 'IRHUB', viewValue: 'IR허브(IRHG-01)', pvsValue: ''},
      {value: 'ogs_wifi_02', modelValue: 'IRHM-01', typeValue: 'IRHUB', viewValue: 'IR허브(IRHM-01)', pvsValue: ''},
      {value: 'ogs_wifi_03', modelValue: 'IRBD-01', typeValue: 'IRREMOCON', viewValue: 'IR리모컨(허브X)', pvsValue: ''}
    ]
  }];
  ...
  pvsDeviceGroups: DeviceGroup[] = [
    {
      name: '전략단말(CGS) - ZW',
      deviceList: [
        {value: 'cgs_zw_01', modelValue: '022E00010001', typeValue: 'DOORLOCK', viewValue: '삼성도어락', pvsValue: ''},
        {value: 'cgs_zw_02', modelValue: '021210001000', typeValue: 'DOORLOCK', viewValue: 'GM도어락(보조키)', pvsValue: ''},
        {value: 'cgs_zw_03', modelValue: '0212C6000004', typeValue: 'DOORLOCK', viewValue: 'GM도어락(주키)', pvsValue: ''},
        {
          value: 'cgs_zw_04',
        ...
        {value: 'cgs_zw_06', modelValue: '018C00420002', typeValue: 'PLUG', viewValue: '플러그1(구형/SPD-01)', pvsValue: ''},
        {
          value: 'cgs_zw_07',
        ...
        {value: 'cgs_zw_09', modelValue: 'ID003', typeValue: 'EMETER', viewValue: '에너지미터', pvsValue: ''},
        {value: 'cgs_zw_10', modelValue: '018B00400001', typeValue: 'GASVALVE', viewValue: '가스락', pvsValue: ''},
        {value: 'cgs_zw_11', modelValue: '022C00030001', typeValue: 'DOORSENSOR', viewValue: '열림센서', pvsValue: ''},
        {
          value: 'cgs_zw_12',
        ...
        {value: 'cgs_zw_13', modelValue: '023300470001', typeValue: 'SWITCH', viewValue: '스위치47(구형)', pvsValue: ''},
        {value: 'cgs_zw_14', modelValue: '023300480001', typeValue: 'SWITCH', viewValue: '스위치48(구형)', pvsValue: ''},
        {value: 'cgs_zw_15', modelValue: '023300490001', typeValue: 'SWITCH', viewValue: '스위치49(구형)', pvsValue: ''},
        {value: 'cgs_zw_16', modelValue: '0233004A0001', typeValue: 'SWITCH', viewValue: '스위치4A(신형)', pvsValue: ''},
        {value: 'cgs_zw_17', modelValue: '0233004B0001', typeValue: 'SWITCH', viewValue: '스위치4B(신형)', pvsValue: ''},
        {value: 'cgs_zw_18', modelValue: '0233004C0001', typeValue: 'SWITCH', viewValue: '스위치4C(신형)', pvsValue: ''},
        {value: 'cgs_zw_19', modelValue: '0233004A0002', typeValue: 'SWITCH', viewValue: '스위치4A(개선형)', pvsValue: ''},
        {value: 'cgs_zw_20', modelValue: '0233004B0002', typeValue: 'SWITCH', viewValue: '스위치4B(개선형)', pvsValue: ''},
        {value: 'cgs_zw_21', modelValue: '0233004C0002', typeValue: 'SWITCH', viewValue: '스위치4C(개선형)', pvsValue: ''},
        ...
        {value: 'cgs_zw_25', modelValue: '018C00520001', typeValue: 'MUPTITAP', viewValue: '멀티탭', pvsValue: ''},
        {
          value: 'cgs_zw_26',
          modelValue: '0257004D0001',
          typeValue: 'RLDJRDKSSKA',
          viewValue: '주방소화장치(파라텍)',
          pvsValue: ''
        },
        {value: 'cgs_zw_27', modelValue: '023D00430001', typeValue: 'DOORCAM', viewValue: '도어캠', pvsValue: ''},
        {value: 'cgs_zw_28', modelValue: '022C004E0001', typeValue: 'SIREN', viewValue: '무선경보기(사이렌)', pvsValue: ''},
        {value: 'cgs_zw_29', modelValue: '004720191806', typeValue: 'CURTAINMOTOR', viewValue: '솜피커튼', pvsValue: ''},
        {value: 'cgs_zw_30', modelValue: '004720181805', typeValue: 'BLINDMOTOR', viewValue: '솜피블라인드', pvsValue: ''},
        {value: 'cgs_zw_31', modelValue: '027300530001', typeValue: 'MOTIONSENSOR', viewValue: '모션센서', pvsValue: ''},
        {value: 'cgs_zw_32', modelValue: '022C004E0001', typeValue: 'SIREN', viewValue: '움직임알리미', pvsValue: ''},
        {value: 'cgs_zw_33', modelValue: '014D00540001', typeValue: 'BUTTON', viewValue: 'IoT버튼', pvsValue: ''}
      ]
    },
    {
    ...
    },
    {
      ...
      // disabled: true,
      deviceList: [
        {value: 'cgs_wifi_01', modelValue: '022E33000001', typeValue: 'FEEDER', viewValue: '펫스테이션', pvsValue: ''}
      ]
    },
    {
      ...
      // disabled: true,
      deviceList: [
        {value: 'ogs_wifi_01', modelValue: 'SPTL-W01', typeValue: 'PLUG', viewValue: 'WIFI 플러그', pvsValue: ''},
        {value: 'ogs_wifi_02', modelValue: 'MTTL-W01', typeValue: 'MULTITAP', viewValue: 'WIFI 멀티탭', pvsValue: ''},
        {value: 'ogs_wifi_04', modelValue: 'ID018', typeValue: 'AIRSENSOR', viewValue: '실내기', pvsValue: ''},
        {value: 'ogs_wifi_05', modelValue: 'IAQ-LS100', typeValue: 'AIRSENSOR', viewValue: '보급형 실내기', pvsValue: ''},
        {value: 'ogs_wifi_06', modelValue: 'ID020', typeValue: 'AIRSENSOR', viewValue: '실외기', pvsValue: ''}
      ]
    }];
  ...
  partnerDeviceGroups: DeviceGroup[] = [
    {
      ...
      // disabled: true,
      deviceList: [
        {value: 'cgs_wifi_02', modelValue: 'KITURAMI', typeValue: 'KITURAMI', viewValue: '귀뚜라미', pvsValue: ''},
        {value: 'cgs_wifi_03', modelValue: 'RINNAI', typeValue: 'RINNAI', viewValue: '린나이', pvsValue: ''}
      ]
    },
    {
      name: '미청약단말(OGS) - WIFI',
      // disabled: true,
      deviceList: [
        {value: 'ogs_wifi_07', modelValue: 'SC_SIDIZ_01', typeValue: 'SMARTCHAIR', viewValue: '스마트체어', pvsValue: ''},
      ]
    },
    {
      name: '미청약단말(OAS) - WIFI',
